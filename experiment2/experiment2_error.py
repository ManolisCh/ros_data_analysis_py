...
vel_error = np.genfromtxt('/home/manolis/Dropbox/experiment2_data/vector_vel_error/15_HI_vector_vel_error.txt', delimiter=',', names=True)
#cmd_vel = np.genfromtxt('/home/manolis/Dropbox/experiment2_data/03_HI_cmd_vel.txt', delimiter=',', names=True)
loa_has_changed = np.genfromtxt('/home/manolis/Dropbox/experiment2_data/loa_changed/15_HI_loa_changed.txt', delimiter=',', names=True)
trial_start = np.genfromtxt('/home/manolis/Dropbox/experiment2_data/trial_start/15_HI_start.txt', delimiter=',', names=True)
